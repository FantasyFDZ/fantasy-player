      ...
      messages: [
        {
          ...
          content:
            ...
            "核心要求：\n" +
            "- 完全用第一人称的感受去写：用「我听见」「我仿佛看到」" +
            "「让我想起」这样的视角，不要写「这首歌……」之类的旁白\n" +
            "- 把一个具体的听歌场景自然地融进你的感受里（比如某个雨夜" +
            "的窗前、某段失眠的清晨、某次独自驾车回家的隧道里），" +
            "不要单独列出「适合在……时听」的句子，让场景在感受里自然出现\n" +
            "- 描述音色质感、旋律走向、乐器、人声、画面感、情绪氛围\n" +
            "- 段落连贯，像一段散文式独白\n" +
            "- 有诗意，可以用意象、比喻\n\n" +
            "禁止事项（很重要）：\n" +
            "- 绝对不要提到歌手、乐队、演唱者的名字\n" +
